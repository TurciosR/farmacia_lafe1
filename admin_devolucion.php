<?php
	...
	// Page setup
	$_PAGE = array ();
	$title='Administrar Devoluciones';
	$_PAGE ['title'] = $title;
	$_PAGE ['links'] = null;
...
span.select2-container {
  z-index:10050;
	...
	<div class="wrapper wrapper-content  animated fadeInRight">
		<div class="row" id="row1">
            ...
            <div class='ibox-title'>";
						$filename = 'descargo_inventario_devolucion.php';
						$link=permission_usr($id_user,$filename);
						if ($link!='NOT' || $admin=='1' )
						echo "<a href='descargo_inventario_devolucion.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Nuevo Registro</a>";
            echo "</div>";
            ?>
								...
								<div class="input-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" placeholder="Laboratorio" class="form-control" id="lab" name="lab" value="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
								...
								<table class="table table-striped table-bordered table-hover" id="editable2">
									<thead>
										<tr>
											...
											<th class="col-lg-2">Laboratorio</th>
	...
	<?php
	include("footer.php");
	echo" <script type='text/javascript' src='js/funciones/funciones_admin_devolucion.js'></script>";
		} //permiso del script
else {
