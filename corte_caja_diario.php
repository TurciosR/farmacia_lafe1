...
function initial() {
									...
									<tbody id="table_data">
										<tr>
											...
											<td style="text-align: center">
												<label id="id_total_general"><?php echo number_format(($total_corte_2 - $total_salida_caja - $monto_dev - $monto_nc-$monto_retencion),2,".","");?></label></td>
												<td style="text-align: center">
													<label id="id_diferencia"><?php echo "-".number_format(($total_corte_2 - $total_salida_caja - $monto_dev - $monto_nc-$monto_retencion),2,".","");?></label>
												</td>
											</tr>
										</tbody>
									</table>
	...
	function corte()
	{
		...
		function cambio()
		{
			...
			$total_corte = $total_tike + $total_factura + $total_credito_fiscal + $monto_apertura-$monto_retencion;
