...
WHERE pr.id_producto=su.id_producto AND pr.id_categoria=c.id_categoria AND su.cantidad>0 $ubi AND su.id_sucursal='$_SESSION[id_sucursal]' AND pr.barcode LIKE '%' AND pr.descripcion LIKE '%' GROUP BY pr.id_producto,su.id_estante,su.id_posicion ORDER BY pr.descripcion ");
