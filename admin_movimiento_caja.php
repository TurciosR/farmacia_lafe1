...
function initial()
{
	...
	$sql_movimientos = _query("SELECT mov_caja.*,movimiento_caja_tipo.tipo FROM mov_caja JOIN movimiento_caja_tipo ON movimiento_caja_tipo.id_tipo=mov_caja.id_tipo WHERE entrada = 1 OR salida = 1 AND id_sucursal = '$id_sucursal' AND fecha BETWEEN '$fecha_1' AND '$fecha_2' ORDER BY id_movimiento DESC");
